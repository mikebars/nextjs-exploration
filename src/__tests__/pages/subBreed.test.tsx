...
describe('subBreed', () => {
  it('subBreed snapshot test Left', () => {
  ...
  it('subBreed snapshot test Right', () => {
    expect.hasAssertions()
  ...
  it('subBreed generateGetStaticPaths decodes valid data as Right', async () => {
    expect.hasAssertions()
  ...
  it('subBreed generateGetStaticPaths decodes valid data as Left', async () => {
    expect.hasAssertions()
  ...
  it('subBreed generateGetStaticProps decodes valid data as Right', async () => {
    expect.hasAssertions()
    ...
    await fc.assert(
      fc.asyncProperty(
        ...
        async (r, context) => {
          ...
          const isValid = fp.either.isRight(staticProps.props.subBreedImages)
  ...
  it('subBreed generateGetStaticProps decodes valid data as Left', async () => {
    expect.hasAssertions()
    ...
    await fc.assert(
      fc.asyncProperty(
        ...
        async (r, context) => {
          ...
          const isInvalid = fp.either.isLeft(staticProps.props.subBreedImages)
